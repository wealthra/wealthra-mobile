      ...
      <>
         {!isExpanded && (
            <View style={styles.buttonContainer}>
               <TouchableOpacity style={[styles.toggleButton, { backgroundColor: themeColors.page_background }]} onPress={toggleDrawer}>
                  <SvgXml xml={data[12].drawerIcon ?? null} width={24} height={24} color={themeColors.card_title} />
               </TouchableOpacity>
            </View>
         )}
         ...
         <Animated.View
            ...
            <View style={[styles.menuContainer, { backgroundColor: themeColors.page_background }]}>
               {/* Chevron to collapse drawer */}
               {isExpanded && (
                  <View style={styles.headerContainer}>
                     <View style={styles.logoContainer}>
                        <SvgXml xml={data[0].logo ?? null} width={40} height={40} />
                        <SvgXml xml={data[1].logotext ?? null} width={100} height={30} style={[{ marginLeft: 8 }, { marginTop: 5 }]} />
                     </View>
                     <TouchableOpacity style={styles.closeButton} onPress={toggleDrawer}>
                        <SvgXml xml={data[13].chevronLeft ?? null} width={30} height={30} color={themeColors.card_title} />
                     </TouchableOpacity>
                  </View>
               )}
               ...
               {menuItems.map((item, index) => (
                  <TouchableOpacity
                     ...
                     <SvgXml
                        ...
                        width={24}
                        height={24}
                        color={currentRoute === item.route ? themeColors.green : themeColors.card_title}
                     />
                     <Text
                        style={[
                           styles.menuText,
