  ...
  return (
    <View style={styles.container}>
      <View style={styles.headerSection}>
        <View style={styles.headerButtons}>
          ...
          >
            ...
            <Text
              style={[styles.languageText, { color: themeColors.card_title }]}
            >
              {buttonLanguage}
            </Text>
          </TouchableOpacity>
          ...
          >
            {isDarkMode ? (
              <LightMode color={themeColors.card_title} size={30} />
            ) : (
              <DarkMode color={themeColors.card_title} size={30} />
            )}
          </TouchableOpacity>
        </View>
      </View>
      <View style={styles.logoSection}>
        ...
        <Text style={[styles.underLogoText, { color: themeColors.card_title }]}>
          {t("underLogoText")}
        </Text>
      </View>
      ...
      <View style={styles.features}>
        <Text
          style={[styles.featuresHeader, { color: themeColors.card_title }]}
        >
          {t("featuresHeader")}
        </Text>
        <View style={styles.featureCards}>
          ...
          >
            <View style={styles.cardContent}>
              <View
                style={[styles.circle, { backgroundColor: themeColors.yellow }]}
              >
              ...
              <View style={styles.textContent}>
                <View style={styles.titleWrapper}>
                  ...
                  >
                    {t("features.card1.firstPart")}
                  </Text>
                  <Text
                    style={[styles.featureTitle, { color: themeColors.yellow }]}
                  >
                    {t("features.card1.highlightedPart")}
                  </Text>
                </View>
                <Text
                  style={[
          ...
          >
            <View style={styles.cardContent}>
              <View
                style={[styles.circle, { backgroundColor: themeColors.green }]}
              >
                <Text style={styles.circleText}>%</Text>
              </View>
              <View style={styles.textContent}>
                <View style={styles.titleWrapper}>
                  ...
                  >
                    {t("features.card2.firstPart")}
                  </Text>
                  <Text
                    style={[styles.featureTitle, { color: themeColors.green }]}
                  >
                    {t("features.card2.highlightedPart")}
                  </Text>
                </View>
                <Text
                  style={[
      ...
      <TouchableOpacity
        style={[styles.signUpButton, { backgroundColor: themeColors.green }]}
        onPress={() => navigation.navigate("SignUp")}
      >
        <Text style={styles.signUpButtonText}>{t("signUpText")}</Text>
      </TouchableOpacity>
      <View style={styles.loginContainer}>
        <Text style={[styles.tagline, { color: themeColors.card_title }]}>
          {t("alreadyUser")}
        </Text>
        <TouchableOpacity onPress={() => navigation.navigate("Login")}>
          <Text style={[styles.tagline, { color: themeColors.blue }]}>
            {t("login")}
          </Text>
        </TouchableOpacity>
      </View>
      <Text style={[styles.tagline, { color: themeColors.card_text }]}>
        {t("tagline")}
      </Text>
    </View>
  );
